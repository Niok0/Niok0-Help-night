package com.example.cankyliator;

import androidx.appcompat.app.AppCompatActivity;
import androidx.core.content.ContextCompat;

import android.os.Bundle;
import com.example.cankyliator.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityMainBinding.inflate(getLayoutInflater()); // Инициализируем ViewBinding
        setContentView(binding.getRoot()); // Используем корень ViewBinding
    ...
    // Функции для добавления текста и получения строки
